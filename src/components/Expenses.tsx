      ...
      >
        ...
        <form onSubmit={handleSubmit} className="p-4 md:p-6 space-y-4 md:space-y-6">
          ...
          <div className="pt-2 md:pt-4 flex justify-end gap-2 md:gap-3">
            ...
            <button 
              type="submit"
              className="flex items-center gap-2 px-6 md:px-8 py-2 md:py-2.5 bg-red-500 hover:bg-red-600 text-white rounded-lg md:rounded-xl transition-all font-bold shadow-[0_0_20px_rgba(239,68,68,0.3)] text-[15px] md:text-[16px]"
            >
