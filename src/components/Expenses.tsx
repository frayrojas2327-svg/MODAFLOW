    ...
    <div className="space-y-4 md:space-y-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 md:gap-4">
        <div>
          ...
          <p className="text-white/50 mt-0.5 text-[15px] md:text-[16px]">Controla los egresos de tu negocio.</p>
        </div>
        <div className="flex items-center gap-2 md:gap-3">
          ...
          <button 
            ...
            className="flex items-center justify-center gap-2 px-4 md:px-6 py-2 md:py-2.5 bg-red-500 hover:bg-red-600 text-white rounded-lg md:rounded-xl transition-all font-bold shadow-[0_0_20px_rgba(239,68,68,0.3)] text-[15px] md:text-[16px]"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-6">
        <div className="bg-black p-4 md:p-6 rounded-xl md:rounded-2xl border border-white/5 shadow-xl">
          <p className="text-white/40 text-[15px] md:text-[16px] font-medium uppercase tracking-wider">Total Gastos</p>
          <h4 className="text-xl md:text-2xl font-bold mt-0.5 md:text-red-500">{formatCurrency(totalExpenses)}</h4>
        </div>
        <div className="bg-black p-4 md:p-6 rounded-xl md:rounded-2xl border border-white/5 shadow-xl">
          <p className="text-white/40 text-[15px] md:text-[16px] font-medium uppercase tracking-wider">Gastos este mes</p>
          <h4 className="text-xl md:text-2xl font-bold mt-0.5">{formatCurrency(totalExpenses)}</h4>
        </div>
        <div className="bg-black p-4 md:p-6 rounded-xl md:rounded-2xl border border-white/5 shadow-xl">
          <p className="text-white/40 text-[15px] md:text-[16px] font-medium uppercase tracking-wider">Nro. de Egresos</p>
      ...
      <div className="flex flex-col md:flex-row gap-4">
        <div className="relative flex-1">
          ...
          <input 
            ...
            className="w-full bg-black border border-white/5 rounded-xl py-2 md:py-3 pl-11 md:pl-12 pr-4 focus:outline-none focus:border-red-500/50 transition-colors text-[15px] md:text-[16px]"
          />
        </div>
              ...
              {filteredExpenses.map((expense) => (
                <tr key={expense.id} className="hover:bg-white/[0.02] transition-colors group">
                  <td className="px-4 md:px-6 py-3 md:py-4">
                    <p className="font-semibold text-[15px] md:text-[16px]">{expense.description}</p>
                  ...
                  <td className="hidden md:table-cell px-6 py-4">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[15px] text-white/60">{expense.category}</span>
                    </div>
                  </td>
                  <td className="hidden md:table-cell px-6 py-4">
                  ...
                  <td className="px-4 md:px-6 py-3 md:py-4">
                    <p className="font-bold text-[15px] md:text-[16px] text-red-400">{formatCurrency(expense.amount)}</p>
                  </td>
        ...
        <form onSubmit={handleSubmit} className="p-4 md:p-6 space-y-4 md:space-y-6">
          <div className="space-y-1.5 md:space-y-2">
            ...
            <input 
              ...
              className="w-full bg-white/5 border border-white/10 rounded-lg md:rounded-xl py-2.5 md:py-3 px-3 md:px-4 focus:outline-none focus:border-red-500/50 text-[15px] md:text-[16px]"
          ...
          <div className="grid grid-cols-2 gap-3 md:gap-4">
            <div className="space-y-1.5 md:space-y-2">
              ...
              <div className="relative">
                <select 
                  ...
                  className="w-full bg-black border border-white/10 rounded-lg md:rounded-xl py-2.5 md:py-3 px-3 md:px-4 focus:outline-none focus:border-red-500/50 appearance-none text-[15px] md:text-[16px] text-white"
                >
                  {categories.map(cat => (
                    <option key={cat} value={cat} className="bg-black text-white">{cat}</option>
                  ))}
            ...
            <div className="space-y-1.5 md:space-y-2">
              ...
              <input 
                ...
                className="w-full bg-black border border-white/10 rounded-lg md:rounded-xl py-2.5 md:py-3 px-3 md:px-4 focus:outline-none focus:border-red-500/50 text-[15px] md:text-[16px]"
              />
            </div>
          </div>
          ...
          <div className="pt-2 md:pt-4 flex justify-end gap-2 md:gap-3">
            ...
            <button 
              type="submit"
              disabled={isSaving}
              className="flex items-center gap-2 px-6 md:px-8 py-2 md:py-2.5 bg-red-500 hover:bg-red-600 text-white rounded-lg md:rounded-xl transition-all font-bold shadow-[0_0_20px_rgba(239,68,68,0.3)] text-[15px] md:text-[16px] disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isSaving ? (
